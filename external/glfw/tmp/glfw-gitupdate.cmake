...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "3.3.5"
  WORKING_DIRECTORY "D:/github/icloth-web-application/external/glfw/src/glfw"
...
if("${show_ref_output}" MATCHES "refs/remotes/3.3.5")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3.3.5")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'D:/github/icloth-web-application/external/glfw/src/glfw'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/github/icloth-web-application/external/glfw/src/glfw'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
