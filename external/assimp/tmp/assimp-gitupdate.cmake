...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "v5.1.3"
  WORKING_DIRECTORY "D:/github/icloth-web-application/external/assimp/src/assimp"
...
if("${show_ref_output}" MATCHES "refs/remotes/v5.1.3")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v5.1.3")
...
# yet).
execute_process(
  COMMAND "D:/Git/cmd/git.exe" rev-list --max-count=1 "${git_tag}"
  WORKING_DIRECTORY "D:/github/icloth-web-application/external/assimp/src/assimp"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/assimp/assimp.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      execute_process(
        COMMAND "D:/Git/cmd/git.exe" checkout "${git_remote}/${git_tag}"
        WORKING_DIRECTORY "D:/github/icloth-web-application/external/assimp/src/assimp"
        RESULT_VARIABLE error_code
        )
      if(error_code)
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'D:/github/icloth-web-application/external/assimp/src/assimp'."
        ...
        execute_process(
          COMMAND "D:/Git/cmd/git.exe" tag -a
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/github/icloth-web-application/external/assimp/src/assimp'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
    ...
    execute_process(
      COMMAND "D:/Git/cmd/git.exe" checkout "${git_tag}"
      WORKING_DIRECTORY "D:/github/icloth-web-application/external/assimp/src/assimp"
      RESULT_VARIABLE error_code
      )
    if(error_code)
