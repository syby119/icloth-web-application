...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "v1.42.0"
  WORKING_DIRECTORY "D:/github/icloth-web-application/external/grpc/src/grpc"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.42.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.42.0")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'D:/github/icloth-web-application/external/grpc/src/grpc'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/github/icloth-web-application/external/grpc/src/grpc'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
